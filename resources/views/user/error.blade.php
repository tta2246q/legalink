...
<body class="body">
    ...
    <div style="text-align: center; margin-top:100px">
        <h1 style="font-size: 135px">404</h1>
        <h2>PAGE NOT FOUND</h2>
        <p>sorry, we couldn't find the page you're looking for</p>
    </div>
    <div class="search">
        <form class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" type="search" placeholder="Type Keywords" aria-label="Search">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
          </form>
    </div>
    <div class="back-homepage">
        <a class="back-homepage" href="http://127.0.0.1:8000/home"><p>or back to homepage</p></a>
    </div>
