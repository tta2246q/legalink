...
<head>
    ...
    <link rel="wedsite icon" type="jpg" href="https://th.bing.com/th?q=%e1%ba%a2nh+M%c3%a8o+Cute&w=120&h=120&c=1&rs=1&qlt=90&cb=1&pid=InlineBlock&mkt=en-WW&cc=VN&setlang=vi&adlt=moderate&t=1&mw=247">
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">
                <img src="\assets\wp-content\uploads\sites\6\images\logo-attorna.png" alt="Logo" style="height: 40px;">
            </a>
                    ...
                    <li class="nav-item dropdown drop-down2">
                        ...
                        <div class="dropdown-menu sub-menu2" aria-labelledby="navbarDropdown1">
                            ...
                            <div class="dropdown-item dropdown drop-down3">
                                ...
                                <div class="dropdown-menu sub-menu3" aria-labelledby="navbarDropdown2">
                                    <a class="dropdown-item" href="#">Portfolio Left & Right Large Thumbnail</a>
